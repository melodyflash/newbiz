    ...
    <header className={`fixed top-0 inset-x-0 z-40 transition-all duration-300 ${
        ...
        <a href="#top" className="flex items-center space-x-3">
          <span className="icon-frame">
            <svg viewBox="0 0 24 24" className="h-8 w-8">
              <defs>
                <linearGradient id="logo-neon" x1="0" y1="0" x2="24" y2="24">
                  <stop offset="0" stopColor="#22d3ee" />
                  <stop offset="1" stopColor="#60a5fa" />
                </linearGradient>
              </defs>
              <path
                d="M12 3l7 4v8l-7 4-7-4V7z"
                fill="none"
              ...
              />
              <circle cx="12" cy="12" r="2.6" fill="url(#logo-neon)" />
            </svg>
          </span>
          <div>
            <p className="text-xs uppercase tracking-[0.28em] text-slate-300">Smart Biz Upgrade</p>
            <p className="text-base font-semibold text-slate-50">Neon Sapphire</p>
          </div>
        </a>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="mx-4 mb-4 rounded-2xl border border-cyan-400/30 bg-panel-strong p-6 shadow-theme-glow">
