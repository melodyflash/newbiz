    ...
    <header className={`fixed top-0 inset-x-0 z-40 transition-all duration-300 ${
        ...
        <a href="#top" className="flex items-center space-x-3">
          <span className="icon-frame">
            <svg viewBox="0 0 24 24" className="h-8 w-8">
              <defs>
                <linearGradient id="logo-ember" x1="0" y1="0" x2="24" y2="24">
                  <stop offset="0" stopColor="#fb7185" />
                  <stop offset="1" stopColor="#f97316" />
                </linearGradient>
              </defs>
              <path
                d="M12 4l6 5-6 11-6-11z"
                fill="none"
              ...
              />
              <circle cx="12" cy="9" r="2.5" fill="url(#logo-ember)" />
            </svg>
          </span>
          <div>
            <p className="text-xs uppercase tracking-[0.28em] text-rose-200/80">Smart Biz Upgrade</p>
            <p className="text-base font-semibold text-slate-50">Quantum Ember</p>
          </div>
        </a>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="mx-4 mb-4 rounded-2xl border border-rose-400/45 bg-panel-strong p-6 shadow-theme-glow">
